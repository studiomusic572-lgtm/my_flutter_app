...
Future<void> main() async {
  ...
  if(GetPlatform.isWeb) {
    await Firebase.initializeApp(options: const FirebaseOptions(
      apiKey: 'AIzaSyDdWtwu6H_NryfEZFIL4rWcvtrIUUTbNRk',
      appId: '1:459832035251:web:14a26aa5f950415f5dedc6',
      messagingSenderId: '459832035251',
      projectId: 'deliv-4b593',
    ));
  }else if(GetPlatform.isAndroid) {
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyCzyNqEFNHdeyng_HsTs7HB-qVQO_EnW_U',
        appId: '1:459832035251:android:a78109001c0e76de5dedc6',
        messagingSenderId: '459832035251',
        projectId: 'deliv-4b593',
      ),
    );
